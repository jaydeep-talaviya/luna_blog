...
class Room(models.Model):
    ...
    creater = models.ForeignKey(User, on_delete=models.CASCADE, blank=False, related_name="room_creater")
    room_profile = ResizedImageField(force_format='WEBP', size=None,scale=0.5, quality=75, upload_to='images', blank=True, null=True)
